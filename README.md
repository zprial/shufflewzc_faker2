...
【青龙拉库命令】
ql repo https://github.com/zprial/shufflewzc_faker2.git "jd_|jx_|gua_|jddj_|getJDCookie" "activity|archives" "^jd[^_]|USER|function|utils|sendNotify|ZooFaker_Necklace.js|JDJRValidator_|sign_graphics_validate|ql|JDSignValidator"
