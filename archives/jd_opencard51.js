...
第一个CK失效会退出脚本
————————————————
入口：[ 7.18-7.31萌宠轻量囤货新势界 (https://lzdz1-isv.isvjcloud.com/dingzhi/customized/common/activity/8938022?activityId=dzlhkkde95c4481a4859f30fa6f586）

请求太频繁会被黑ip
过10分钟再执行
*/

let opencard_addSku = "flase"
let opencard = "true"
let openwait = "0"
let opencard_draw = "0"

const $ = new Env('萌宠轻量囤货新势界-开卡')
...
if ($.isNode()) {
  if(opencard+"" != "true"){
    console.log('如需执行脚本请设置环境变量为"true"')
  }
  if(opencard+"" != "true"){
    return
  }
...
$.activityId = "dzlhkk4158ec94b101401c86b9a1d7"
$.shareUuid = ""
...
try {
  ...
  if(!$.addCart && !$.outFlag){
    if(opencard_addSku+"" == "true"){
      ...
      console.log('如需加购请设置环境变量opencard_addSku为"true"');
    }
  }
  if(flag){
    await takePostRequest('activityContent');
